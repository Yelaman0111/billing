    ...
    <div class="overflow-hidden overflow-x-auto min-w-full align-middle sm:rounded-md">
        <div class="flex place-content-end mb-4">
            <div class="px-4 py-2  bg-indigo-600 hover:bg-indigo-700 cursor-pointer">
                <router-link :to="{ name: 'users.create' }" class="text-sm font-medium">Create user</router-link>
            </div>
        </div>
        ...
        <table class="min-w-full border divide-y divide-gray-200">
            ...
            <tr>
                ...
                <th class="px-6 py-3 bg-gray-50">
                    <span
                        class="text-xs font-medium tracking-wider leading-4 text-left text-gray-500 uppercase">Login</span>
                </th>
                <th class="px-6 py-3 bg-gray-50">
                    <span
